...
<?php
	...
	function saveSVGEval(){
		
		API_DB::getInstance()->setSVG("hii");
		echo("asdfgaksfgaskjhf");
	}*/
...
?>
  ...
  <div class="menu">
  	...
  	<div class="menu_list" id="file_menu"> 
  		...
  		<div id="tool_save_file" class="menu_item">Save SVG for Evaluation.</div>
		<!--<div id="tool_save_filee" class="menu_item" onclick="saveSVGEval()">Save SVG for Evaluation.</div>-->
