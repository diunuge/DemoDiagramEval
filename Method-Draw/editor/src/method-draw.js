  ...
  //              var ref_data = Actions.getButtonData(opts.button);
    ...
    //    updateBgImage();
	  ...
	  var clickSaveFile = function(){
        ...
        var svg = svgCanvas.getSVGtoString(saveOpts);
		
		//console.log(svg);
		
		$.ajax({
		    crossDomain: true,
		    url: 'http://localhost/demo/answer/save.php/',
		    type: 'POST',
		    data: {
		       'svg': svg, 
		    },
    ...
    var changeCanvasSize = function(ctl){
      ...
      var Actions = function() {
        ...
        var tool_buttons = [
          ...
          {sel:'#tool_save_file', fn: function() { editingsource?saveSourceEditor():clickSaveFile()}, evt: 'mouseup', key: [modKey + 'S' + 'D', true]},
